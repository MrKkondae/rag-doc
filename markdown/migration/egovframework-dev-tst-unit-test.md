---
id: "egovframework-dev-tst-unit-test"
title: "Unit Test"
version: "4.3"
category: "development"
source: "eGovFrame Wiki"
source_url: "https://www.egovframe.go.kr/wiki/doku.php?id=egovframework%3Adev%3Atst%3Aunit_test"
format: "markdown"
---
...
[이미지]
#### TestCase 작성
- 개발자가 구현도구를 통해 코드를 작성할 때, 그 코드를 대상으로 하는 TestCase를 작성할 수 있다. 예를 들어, OOService 클래스의 TestCase인 OOServiceTest를 작성할 수 있는 기반 Framework인 Unit Test Framework을 제공한다. - Test Case
...
| 이름 | 버전 | 설명 |
| --- | --- | --- |
| [ JUnit](http://junit.org/ ) | 4.4, 4.3 | 단위 테스트 클래스 작성과 실행을 위한 기본적인 기능을 제공 |
| [ EasyMock](http://www.easymock.org/ ) | 2.4 | 단위 테스트 클래스 작성 시 Mocking 을 위해 사용 |
| [ DbUnit](http://dbunit.sourceforge.net/ ) | 2.4.2 | 데이터베이스 관련 Test Fixture 자동 생성 등의 DB Support 를 위해 사용 |
| [ EMMA](http://emma.sourceforge.net/ ) | 2.0 | Test Coverage 분석 |
| [ Spring Test](http://www.springsource.org/ ) | 2.5.6 | Springframework 의 Test 관련 기능 활용 |
| [ Unitils](http://unitils.sourceforge.net/ ) | 2.2 | JUnit, EasyMock, DbUnit, Spring Test, Ibatis, Hibernate 등을 유연한 구조로 엮어서 테스트할 수 있는 기반 구조 및 유틸을 제공 |
| [ Ant](http://ant.apache.org/ ) | 1.6.5 이상 | Java-based build tool |
| [ Maven](http://unitils.sourceforge.net/summary.html ) | 2.0 | 프로젝트 관리 도구 |
| [ EclEmma](http://www.eclemma.org ) | 1.3.2 | EMMA Eclipse Plug-in |
## 환경설정
