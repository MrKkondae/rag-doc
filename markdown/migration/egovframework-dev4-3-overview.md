---
id: "egovframework-dev4-3-overview"
title: "개발프레임워크 개발환경 소개"
version: "4.3"
category: "development"
source: "eGovFrame Wiki"
source_url: "https://www.egovframe.go.kr/wiki/doku.php?id=egovframework%3Adev4.3%3Aoverview"
format: "markdown"
---

# 개발프레임워크 개발환경(v4.3) 소개
## 개요
...
### 개발자 개발환경과 서버 개발환경
#### 개발자 개발환경
개발자 개발환경은 Implementation Tool(Editor, Debug, IDE, Common Component, Mobile IDE, Batch IDE)과 Test Tool(Test Reporting, Unit Test, Batch Test)로 구성되어있다. [이미지]
...
개발자는 프로젝트의 상황에 적합한 환경을 다운로드하여 사용하도록 한다. #### 서버 개발환경
서버 개발환경은 Deployment Tool(Build, Deploy)과 Conf. & Change Mgt. Tool(Configuration Management, Change Management)로 구성되어 있다. [이미지]
...
| Servlet | 3.1 이상 |  |
| Eclipse IDE for Enterprise Java and Web Developers | 4.31.0 (2024-03) - Windows/Linux 4.33.0 (2024-09) - MacOS | https://www.eclipse.org/downloads/packages/release/2024-03/r https://www.eclipse.org/downloads/packages/release/2024-09/r |

* 개발환경 4.2.0
^  항목  ^  권장버전  ^  비고  |
| Java Development Kit | 17 이상 |
| Servlet | 3.1 이상 |  |
| Eclipse IDE for Java EE Developers | 4.26.0 (2022-12) | https://www.eclipse.org/downloads/packages/release/2022-12/r |
...
### WAS
^이름 ^권장버전 ^자바호환성 ^비고 |
| Apache Tomcat | 8.5.x 이상 | JDK 7.0 이상 | Servlet 3.1 참고 :https://tomcat.apache.org/whichversion.html |
### Open Source Software 사용 현황
[전자정부 표준프레임워크 버전별 오픈소스SW 구성 참고](http://www.egovframe.go.kr/EgovOSS.jsp?menu=1&submenu=2&leftsub=3)
