---
id: "egovframework-dev4-3-tst-spotbugs"
title: "SpotBugs"
version: "4.3"
category: "development"
source: "eGovFrame Wiki"
source_url: "https://www.egovframe.go.kr/wiki/doku.php?id=egovframework%3Adev4.3%3Atst%3Aspotbugs"
format: "markdown"
---
 ...
 * SpotBugs는 오픈소스이며 contributions에 열려있음
 ...
 공식 홈페이지인 https://github.com/spotbugs/spotbugs 를 통해 소프트웨어에 대한 소개와 튜토리얼을 제공하고 있으며, LGPL 공개소프트웨어 라이선스에 따라 소프트웨어 다운로드 기능을 제공한다.
...
## 설치
#### Spotbugs 설치
(참고 : 표준프레임워크 통합개별환경은 이미 설치되어있음) ##### 1. Help > Eclipse MarketPlace...를 선택한다.
[이미지] ##### 2. Find 창에서 Spotbugs를 검색하고 install 한다.
[이미지]
## 설정
1. https://find-sec-bugs.github.io/ 에서 플러그인을 다운로드 받는다.
[이미지]

2. Eclipse > Windows > Prefeneces > Spotbugs 선택==
[Reporting configuration]탭의 [Reported (Visible) bug categories]목록에서 [Security]만 체크되어 있는지 확인한다.
[이미지]

3. [ Plugins and misc . settings ]섹션에 보안 버그 검색 플러그인을 추가할 수 있다.
Add... 클릭하여 다운로드 받은 findsecbugs-plugin.jar 파일을 선택한다.
...
4. 다시 Spotbugs Preference창을 열어서 Detector configuration 탭을 선택한다.
FindSecurityBugs의 룰셋들이 추가된 것을 확인할 수 있다.
[이미지]
...
| 취약한 API 사용 |  |  |  |
## 참고사이트
1. FindSecurityBugs, http://find-sec-bugs.github.io/
2, 보안약점 진단 가이드, https://www.kisa.or.kr/2060204/form?postSeq=9&page=1
3. SpotBugs, FindSecurityBugs, PMD 보안약점 관련 룰, https://www.mois.go.kr/frt/bbs/type001/commonSelectBoardArticle.do?bbsId=BBSMSTR_000000000012&nttId=73814
4. 표준프레임워크 보안 개발 가이드, https://www.egovframe.go.kr/home/ntt/nttRead.do?pagerOffset=0&searchKey=&searchValue=&menuNo=76&bbsId=171&nttId=1813
