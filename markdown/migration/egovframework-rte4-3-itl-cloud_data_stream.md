---
id: "egovframework-rte4-3-itl-cloud_data_stream"
title: "Cloud Data Stream"
version: "4.3"
category: "runtime"
source: "eGovFrame Wiki"
source_url: "https://www.egovframe.go.kr/wiki/doku.php?id=egovframework%3Arte4.3%3Aitl%3Acloud_data_stream"
format: "markdown"
---
...
## 특징
### Data Stream
비동기 데이터 처리는 지속적으로 발생하는 데이터에 대하여 실시간으로 처리 하는데 주요 목적이 있으며,
시간에 비교적 민감한 자료의 처리에 적합하며 다양한 지리적 위치에서 다양한 형식으로 전달될 수 있다.
### Data Stream , Batch 비교
[이미지: Data Stream , Batch 비교]
| 배치 처리 | 비동기 데이터 처리 |
| --- | --- |
...
<del>@EnableBinding</del>
<del>@StreamListener</del>
<del>@Input</del>
<del>@Output</del>
<del>@StreamMessageConverter</del>
## 설정방법
### pom.xml 설정
...
- [Functional Inteface](https://docs.oracle.com/javase/8/docs/api/java/util/function/package-summary.html)
