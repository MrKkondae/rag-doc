---
id: "egovframework-dev-overview"
title: "개발프레임워크 개발 환경 개요"
version: "4.3"
category: "development"
source: "eGovFrame Wiki"
source_url: "https://www.egovframe.go.kr/wiki/doku.php?id=egovframework%3Adev%3Aoverview"
format: "markdown"
---
...
## 설명
### 개발환경 목표
개발환경은 개발자 프로그램 개발에 필요한 IDE 를 기반으로 비즈니스 프로그램 개발, 버전관리, 단위 테스트, 빌드 등의 개발 Life-Cycle 전반에 대한 지원 도구를 제공한다. - Implementation Tool
- Test Tool
