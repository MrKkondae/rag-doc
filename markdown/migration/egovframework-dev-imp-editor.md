---
id: "egovframework-dev-imp-editor"
title: "Editor"
version: "4.3"
category: "development"
source: "eGovFrame Wiki"
source_url: "https://www.egovframe.go.kr/wiki/doku.php?id=egovframework%3Adev%3Aimp%3Aeditor"
format: "markdown"
---
...
[이미지] <그림 1> eGovFrameWork Editor의 기본 주요 구성 영역
...
[이미지] <그림 2> eGovFrameWork 홈페이지 접속

[이미지] <그림 3> "다운로드>개발환경" 으로 이동

[이미지] <그림 4> "구현도구" 게시물 조회

[이미지] <그림 5> 첨부파일 다운로드

[이미지] <그림 6> eGovFramework Editor 실행
## 업데이트
...
[이미지] <그림 7> Software Updates

[이미지] <그림 8> "Available Software" 목록

[이미지] <그림 9> Location 입력
