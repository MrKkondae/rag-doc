---
id: "egovframework-dev-isu-change-management"
title: "Change Management"
version: "4.3"
category: "development"
source: "eGovFrame Wiki"
source_url: "https://www.egovframe.go.kr/wiki/doku.php?id=egovframework%3Adev%3Aisu%3Achange_management"
format: "markdown"
---
...
스페이스에 할당된 사용자에게 롤을 부여하면 사용자는 등록된 롤을 기반으로 스페이스의 이슈를 관리할 수 있다.
Change Management에서는 롤을 등록하여 관리할 수 있는 기능을 제공한다.
...
- WAR File 압축을 해제한 후 설정파일을 수정한다.
-  DBMS별 어플리케이션 설정파일 수정
-  검색엔진 lucene 설정파일 수정
- WAR File을 WAS 서버에 deploy 한다.
##### 테이블 생성
- 테이블 생성 스크립트를 다운로드 받는다.
- My SQL : [이미지: issue_mysql.script]
- Oracle : [이미지: issue_oracle.script]
- Altibase : [이미지: issue_altibase.script]
- Tibero : [이미지: issue_tibero.script]
- 스크립트를 실행하여 테이블을 생성한다.
##### 설치 완료 후 테스트
- web-browser에서 'http://domain:port/egovframework-dev-isu'를 연다.
