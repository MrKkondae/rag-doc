---
id: "egovframework-dev-imp-editor-webflow-editor"
title: "WebFlow Editor"
version: "4.3"
category: "development"
source: "eGovFrame Wiki"
source_url: "https://www.egovframe.go.kr/wiki/doku.php?id=egovframework%3Adev%3Aimp%3Aeditor%3Awebflow_editor"
format: "markdown"
---
...
[이미지]
## 사용법
- 메뉴 표시줄에서 **_F_ile** > **_N_ew** > **Spring Web Flow Definition**을 선택한다. (단 eGovFramework Perspective내에서) 또는, **Ctrl+N** 단축키를 이용하여 새로작성 마법사를 실행한 후 **Spring** > **Spring Web Flow Definition**을 선택하고 **_N_ext**를 클릭한다. [이미지]
- 파일 위치를 선택하고 **File name**을 입력하고 **_F_inish**를 클릭한다.
- **Project Explorer**에서 새로 작성된 WebFlow 설정 파일을 선택 마우스 오른쪽 버튼 클릭 후 **Open _G_raphical Editor**를 선택한다.
- WebFlow를 작성 후 저장한다.
### = 참고자료
- [Spring WebFlow Editor](http://springide.org/project/wiki/WebFlowEditor)
- [ Spring WebFlow의 소개글 (한글번역)](http://openframework.or.kr/Wiki.jsp?page=SpringWebFlowIntroduction )
