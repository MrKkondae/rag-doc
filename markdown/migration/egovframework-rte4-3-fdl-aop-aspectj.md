---
id: "egovframework-rte4-3-fdl-aop-aspectj"
title: "@AspectJ 어노테이션을 이용한 AOP 구현"
version: "4.3"
category: "runtime"
source: "eGovFrame Wiki"
source_url: "https://www.egovframe.go.kr/wiki/doku.php?id=egovframework%3Arte4.3%3Afdl%3Aaop%3Aaspectj"
format: "markdown"
---
...
| bean(*dataSource) <nowiki> |  | </nowiki> bean(*DataSource) | 이름이 "dataSource" 나 "DataSource" 으로 끝나는 모든 빈 |
### 충고(Advice) 정의하기
...
## 참고자료
- [Spring Framework - Reference Document / 5.4 @AspectJ support](https://docs.spring.io/spring-framework/docs/5.3.37/reference/html/core.html#aop-ataspectj)
