---
id: "egovframework-dev-imp-editor-dbio-editor-sql-map-config-editor"
title: "SQL Map Config Editor"
version: "4.3"
category: "development"
source: "eGovFrame Wiki"
source_url: "https://www.egovframe.go.kr/wiki/doku.php?id=egovframework%3Adev%3Aimp%3Aeditor%3Adbio_editor%3Asql_map_config_editor"
format: "markdown"
---
...
[이미지] <sup> <그림 1> SqlMap Config Editor </sup>
## 설명 =
...
- 상단 메뉴의 (("eGovFramework" 메뉴는 eGovFramework Perspective 환경에서만 나타난다.)) eGovFramework -> Implementation -> New SQL Map Config 또는 Context Menu의 New -> sqlMapConfig 를 통해 파일을 생성한다. [이미지] <sup> <그림 2> sqlMapConfig 생성방법 1 </sup> [이미지] <sup> <그림 3> sqlMapConfig 생성방법 2 </sup>
...
[이미지] <sup> <그림 4> SQL Map Config File의 선택 </sup>
...
[이미지] <sup> <그림 5> SQL Map Config Editor 로 자동으로 열리지 않을 경우  </sup>
...
[이미지] <sup> <그림 6> Transaction Manager  </sup>
### SQL Map 목록 사용법
[이미지] <sup> <그림 7> SQL Map 목록 </sup>
...
[이미지] <sup> <그림 8> SQL Map 파일 검색   </sup>


[이미지] <sup> <그림 9> SQL Map 파일 신규 생성 화면  </sup>


[이미지] <sup> <그림 10> SQL Map 목록의 filter 적용  </sup>
...
[이미지] <sup> <그림 11> SQL Map Config 파일 직접 수정  </sup>
