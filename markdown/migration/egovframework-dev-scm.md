---
id: "egovframework-dev-scm"
title: "소스관리도구 클라이언트환경 사용"
version: "4.3"
category: "development"
source: "eGovFrame Wiki"
source_url: "https://www.egovframe.go.kr/wiki/doku.php?id=egovframework%3Adev%3Ascm%3A%EC%86%8C%EC%8A%A4%EA%B4%80%EB%A6%AC%EB%8F%84%EA%B5%AC_%ED%81%B4%EB%9D%BC%EC%9D%B4%EC%96%B8%ED%8A%B8%ED%99%98%EA%B2%BD_%EC%82%AC%EC%9A%A9"
format: "markdown"
---
...
- [이미지: Subversive Eclipse IDE 플러그인 아이콘]과 같은 모양의 아이콘에 마우스를 올려 버전을 확인한다.
...
[이미지: Subversice Eclipse IDE 플러그인 버전 확인과 업데이트]
## 주요 개념 및 사용법
...
- postpone: 즉시 반영없이, 소스 코드를 계속 수정. 수정이 완료된 시점에 다시 시도
(충돌 해결 안함)
