---
id: "egovframework-dev4-3-imp-codegen"
title: "Code Generation"
version: "4.3"
category: "development"
source: "eGovFrame Wiki"
source_url: "https://www.egovframe.go.kr/wiki/doku.php?id=egovframework%3Adev4.3%3Aimp%3Acodegen"
format: "markdown"
---
...
- 하위 항목중 "eGovFrame CodeGen", "eGovFrame CodeGen Templates"를 체크한 후 "Next"를 클릭하여 설치를 진행한다. (<그림 2> 참조) [이미지: menu] <그림 1> Menu  [이미지: Install CodeGen] <그림 2> Install CodeGen
#### 2. URL을 이용한 업데이트
...
- Url 의 하위 트리 항목을 확장하여 eGovFrame의  "eGovFrame CodeGen", "eGovFrame CodeGen Templates"를 체크한 후 "Next"를 클릭하여 설치를 진행한다.(<그림 4> 참조) [이미지: Install New Software] <그림 3> Install New Software  [이미지: Software Update] <그림 4> Location 입력 및 Software Update
## 업데이트 주의사항
