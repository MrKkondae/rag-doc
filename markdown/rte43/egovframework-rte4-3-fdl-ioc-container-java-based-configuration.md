---
id: "egovframework-rte4-3-fdl-ioc-container-java-based-configuration"
title: "Java-based configuration"
version: "4.3"
category: "rte43"
source: "eGovFrame Wiki"
source_url: "https://www.egovframe.go.kr/wiki/doku.php?id=egovframework%3Arte4.3%3Afdl%3Aioc_container%3Ajava-based_configuration"
format: "markdown"
---
...
```
### @Bean 어노테이션 사용
@Bean은 메소드 레벨 어노테이션이며 XML <bean/> 요소와 동일하며 <bean/>에서 제공하는 일부 속성을 지원한다.
또한, @Configuration 어노테이션 또는 @Component 어노테이션 클래스에서 @Bean 어노테이션을 사용할 수 있다.
#### Bean 선언
...
```
#### @Scope 어노테이션 사용
@Bean 어노테이션으로 정의된 Bean이 특정 범위를 갖도록 지정할 수 있으며, 선언된 Bean의 범위는 eGovframework:rte4.2:fdl:IoC Container:Bean scope에 지정된 표준 범위를 사용할 수 있다.
...
```
## 참고자료
- [Spring Framework - Reference Document / 1.12. Java-based Container Configuration](https://docs.spring.io/spring-framework/docs/5.3.37/reference/html/core.html#beans-java)
