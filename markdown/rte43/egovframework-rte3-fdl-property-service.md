---
id: "egovframework-rte3-fdl-property-service"
title: "Property Service"
version: "4.3"
category: "rte43"
source: "eGovFrame Wiki"
source_url: "https://www.egovframe.go.kr/wiki/doku.php?id=egovframework%3Arte3%3Afdl%3Aproperty_service"
format: "markdown"
---
...
```
- propertyService Bean을 추가할 경우 messageSource Bean도 함께 설정해 주어야 한다. - 아래의 코드를 추가 설정한다.
##### messageSource
```xml
