---
id: "egovframework-rte4-3-fdl-ioc-container-basics"
title: "Basics"
version: "4.3"
category: "rte43"
source: "eGovFrame Wiki"
source_url: "https://www.egovframe.go.kr/wiki/doku.php?id=egovframework%3Arte4.3%3Afdl%3Aioc_container%3Abasics"
format: "markdown"
---
...
Annotation을 사용한 설정 방법은 eGovframework:RTE:FDL:IoC Container:Annotation-based configuration에서 설명하고 있다.
...
```
## 참고자료
- [Spring Framework - Reference Document / 1.1 Introduction to the Spring IoC Container and Beans](https://docs.spring.io/spring-framework/docs/5.3.37/reference/html/core.html#beans-introduction)
